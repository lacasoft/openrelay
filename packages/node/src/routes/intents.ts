...
import { NODE_FEE_SHARE, PROTOCOL_FEE_BPS } from '@openrelay/protocol'
import type { FastifyInstance } from 'fastify'
import { keccak256, toHex } from 'viem'
import { privateKeyToAccount } from 'viem/accounts'
import { type ChainClient, createChainClient, verifyUsdcTransfer } from '../lib/chain-verify'
...
export async function intentsRoute(app: FastifyInstance) {
  ...
  }>('/intents/:id/settle', async (req, reply) => {
    const { id } = req.params
